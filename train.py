...
parser.add_argument('-exp_name', help='directory for saving the networks of the experiment',default="runs1" ,type=str)
parser.add_argument('-seed', help='set random seed', default=19, type=int)
parser.add_argument('-num_epochs', help='number of epochs', default=200, type=int)
parser.add_argument('-pt', help='number of epochs', default='./runs1/best_all', type=str)
...
#-------------------------------------------------------------------------------------------------------------
    ...
    torch.save(net, './{}/latest_all'.format(exp_name))
    ...
    print_log(f"epoch：{epoch+1}", f"train_psnr:{train_psnr}", f"val_psnr:{val_psnr}", f"val_ssim:{val_ssim}", exp_name)
    # print("Test1")
    # print_log(epoch+1, num_epochs, one_epoch_time, train_psnr, val_psnr2, val_ssim2, exp_name)

    # --- update the network weight --- #
    if val_psnr >= old_val_psnr:
        torch.save(net, './{}/best_all'.format(exp_name))
        print('model saved')
